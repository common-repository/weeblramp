...
/**
 * Integration with Easy Digitals Downloads
 *
 */
class WeeblrampIntegration_Easydigitaldownloads extends WeeblrampClass_Integration {

	protected $id = 'easy-digital-downloads/easy-digital-downloads.php';
	...
	/**
	 * Adds EasyDigitalDownloads custom post types taxonomies to the list
