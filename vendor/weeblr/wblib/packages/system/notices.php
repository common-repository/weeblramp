...
class WblSystem_Notices {
	 ...
	 * @param array  $options
	 *      string type WblSystem_Notices::ERROR | WblSystem_Notices::SUCCESS | WblSystem_Notices::WARNING | WblSystem_Notices::ALERT
	 *      string dismissal WblSystem_Notices::CAN_DISMISS | WblSystem_Notices::CANNOT_DISMISS
